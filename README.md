...
- <img src="https://cdn.simpleicons.org/npm/CB3837" height="14"/> [Bilig WorkPaper](https://github.com/proompteng/bilig) - Formula-backed WorkPaper MCP server for agents and Node services: edit spreadsheet cells through an API, recalculate formulas, verify readback, and persist JSON without driving Excel UI.
