...
- <img src="https://proompteng.github.io/bilig/assets/favicon.svg" height="14"/> [Bilig WorkPaper](https://github.com/proompteng/bilig) - Formula-backed WorkPaper MCP server for agents that need spreadsheet-style calculation, exact readback, input edits, and persisted JSON without spreadsheet UI automation.
