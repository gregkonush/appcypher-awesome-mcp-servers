...
- <img src="https://raw.githubusercontent.com/proompteng/bilig/main/docs/assets/favicon.svg" height="14"/> [Bilig WorkPaper](https://github.com/proompteng/bilig) - Local stdio MCP server for formula-backed workbook automation: edit input cells, recalculate, verify readback, and persist WorkPaper JSON from TypeScript services.
