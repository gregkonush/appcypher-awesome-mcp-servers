...
- <img src="https://raw.githubusercontent.com/proompteng/bilig/main/docs/assets/favicon.svg" height="14"/> [Bilig WorkPaper](https://github.com/proompteng/bilig/tree/main/packages/headless) - Formula-backed WorkPaper MCP server for agents to edit spreadsheet inputs, recalculate formulas, verify readback, and persist JSON without driving Excel UI.
