...
- [Bilig WorkPaper](https://github.com/proompteng/bilig) - Formula WorkPaper MCP server for agent workflows: edit cells, recalculate formulas, verify readback, and persist JSON without driving Excel or spreadsheet UI automation.
