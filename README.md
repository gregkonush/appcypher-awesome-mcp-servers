...
- <img src="https://raw.githubusercontent.com/proompteng/bilig/main/docs/assets/favicon.svg" height="14"/> [Bilig WorkPaper](https://github.com/proompteng/bilig) - Headless spreadsheet WorkPaper server for formula-backed workbook readback, verified input edits, and JSON persistence via `@bilig/headless`.
